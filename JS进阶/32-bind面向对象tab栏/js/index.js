class Tab {
    ...
    init() {
            this.updateNode();
            this.addtab.onclick = this.addTab.bind(this.addtab, this);
            for (var i = 0; i < this.lis.length; i++) {
                this.lis[i].index = i;
                this.lis[i].onclick = this.toggleTab.bind(this.lis[i], this); //不写this.toggleTab()，否则在页面加载的时候就会调用这个方法
    ...
    addTab(that) {
            ...
            this.tabscon.appendChild(section); */
            that.clearClass();
    ...
    removeTab(that, e) {
            ...
            this.tabscon.removeChild(this.tabscon.children[index]); */
